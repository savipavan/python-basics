...
Module:
    *.py
    we import module in script
    by 'import filename'
    contains re-usable code

* scripts and modules are independent
question: Can I make a file which have both module and script??
Ans: I can import and execute as well

# File structure is
# file.py
    module part (gets imported)
    if __name__ == '__main__:
        script part(gets executed)
