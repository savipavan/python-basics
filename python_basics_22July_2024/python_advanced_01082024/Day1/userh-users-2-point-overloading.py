...
dynamic vs static
    typed based checking happens at runtie vs compile time
    in py - no overloading possible

# has relation
#GOLD - 5% cashback, Silver-2%, Normal = 0%
#GoldUser, Silver, Normal and BankUser - where to put?
    when we don't know where to apply, we need to find Design Pattern
